...
namespace SimulationConstants {
	...
	/*-------------------------------Detector Materials------------------------------*/
	//Aerogel
	const G4double aerogel_density = 0.531*kg/m3;         //$ Aerogel density> 0.200*g/cm3
	...
	const G4double PhotonMinEnergy_= 1.8*CLHEP::eV;        //$ Minimum threshold for photon generation> 1.3 = lower end of visible
	const G4double PhotonMaxEnergy_= 3.1*CLHEP::eV;         //$ Maximum threshold for photon generation> 3.18 = upper end of visible
	//Environment
	...
	const G4double uniformEnergyRadius = 50.0;              //$ Radius of uniform energy>
	//momentum
	const std::string momentumDistribution = "divergence";      //$ Momentum distribution> "exact" , "uniform", "gaussian", "divergence"
	...
	//location
	const std::string source = "uniform";                    //$ Particle source location> "exact", "gaussian_plane", "uniform_plane"
	const G4double uniform_source_center = 0*cm;           //$ Uniform source location center>
	const G4double uniform_source_radius = 2*mm;           //$ Uniform source location radius>
	...
	const G4int maxBetaChange = 100;                       //$ Max beta change>
